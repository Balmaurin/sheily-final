...
def main():
    ...
    parser.add_argument(
        "--branch",
        type=str,
        help="Nombre de la rama a entrenar (ej: physics, sports)"
    )
    ...
    parser.add_argument(
        ...
        help="Modelo base a usar (default: Llama-2-7b)"
    )
    ...
    parser.add_argument(
        "--lora",
        action="store_true",
        help="Usar LoRA para entrenamiento eficiente"
    )
