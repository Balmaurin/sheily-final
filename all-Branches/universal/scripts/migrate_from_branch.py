...
def main():
    parser = argparse.ArgumentParser(
        description="Migra datos de una rama al Sistema Universal"
    )
    parser.add_argument(
        "branch",
        type=str,
        help="Nombre de la rama a migrar (ej: antropologia)"
    )
    parser.add_argument(
        "--skip-training",
        action="store_true",
        help="No migrar datasets de training/"
    )
    parser.add_argument(
        "--skip-corpus",
        action="store_true",
        help="No migrar corpus/spanish/"
    )
