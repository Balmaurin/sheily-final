...
class SystemHealth:
    ...
    def unhealthy_components(self) -> List[str]:
        ...
        return [c.name for c in self.components if c.status == HealthStatus.UNHEALTHY]
...
class HealthChecker:
    ...
    def _check_system(self) -> ComponentHealth:
        ...
        try:
            ...
            return ComponentHealth(name="system", status=HealthStatus.UNHEALTHY, message=str(e))
    ...
    def check_all(self) -> SystemHealth:
        ...
        for name, check_fn in self.checks.items():
            try:
                ...
                components.append(
                    ComponentHealth(name=name, status=HealthStatus.UNHEALTHY, message=f"Check failed: {e}")
                )
        ...
        return SystemHealth(status=overall_status, components=components, system_info=system_info)
