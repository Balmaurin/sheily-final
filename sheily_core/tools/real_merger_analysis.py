...
class RealMergerAnalyzer:
    ...
    def analyze_integration_context(self, query: str, specialized: str, general: str) -> Dict[str, Any]:
        """
    ...
    def analyze_consensus(self, sources: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        """
        if not sources:
            return {"consensus_level": 0.0, "agreement_score": 0.0, "divergence": 1.0, "primary_source": None}
    ...
    def build_consensus_response(self, sources: List[Dict[str, Any]], analysis: Dict[str, Any]) -> str:
        """
        ...
        if consensus_level >= 0.7:
            response_parts = ["**Respuesta Consolidada** (alto consenso)\n", base_response]
        else:
        ...
        response_parts.append(f"\n\n*Nivel de consenso: {consensus_level:.0%} | " f"Fuentes: {len(sources)}*")
    ...
    def evaluate_merge_characteristics(self, merge_input: Any) -> Dict[str, Any]:
        ...
        if not specialized_resp:
            return {"complexity_high": False, "sources_multiple": False, "needs_integration": False}
    ...
    def analyze_branch_complementarity(self, responses: List[Any]) -> Dict[str, Any]:
        ...
        """
        if len(responses) < 2:
            return {"high_complementarity": False, "complementarity_score": 0.0, "overlap_percentage": 0.0}
        ...
        logger.debug(f"Complementarity: score={complementarity_score:.3f}, " f"overlap={overlap_percentage:.3f}")
        return result

    def assess_multi_branch_quality(self, response: str, original_responses: List[Any]) -> float:
        """
