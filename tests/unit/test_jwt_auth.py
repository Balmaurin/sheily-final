...
class TestJWTAuthManager:
    ...
    def test_jwt_manager_initialization(self, test_env_vars):
        ...
        from sheily_core.security.jwt_auth import JWT_AVAILABLE, JWTAuthManager
    ...
    def test_validate_expired_token(self, test_env_vars):
        ...
        manager = JWTAuthManager(secret_key="test_secret_key_at_least_32_chars_long_12345", token_expiry_minutes=0)
    ...
    def test_check_permission_hierarchy(self, test_env_vars):
        ...
        from sheily_core.security.jwt_auth import JWT_AVAILABLE, JWTAuthManager, TokenPayload
        ...
        admin_payload = TokenPayload(user_id="admin1", role="admin", exp=9999999999, iat=1234567890)
        ...
        trainer_payload = TokenPayload(user_id="trainer1", role="trainer", exp=9999999999, iat=1234567890)
        ...
        user_payload = TokenPayload(user_id="user1", role="user", exp=9999999999, iat=1234567890)
