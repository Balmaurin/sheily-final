...
class TestComponentHealth:
    ...
    def test_component_health_with_metadata(self):
        ...
        component = ComponentHealth(
            ...
            status=HealthStatus.HEALTHY,
            message="Disk OK",
            metadata={"free_gb": 100, "used_percent": 50}
        )
...
class TestSystemHealth:
    ...
    def test_system_health_creation(self):
        ...
        from sheily_core.health import SystemHealth, ComponentHealth, HealthStatus
        
        components = [
            ComponentHealth(name="test1", status=HealthStatus.HEALTHY, message="OK")
        ]
