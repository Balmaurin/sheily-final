...
class TestRealMergerAnalyzer:
    ...
    def test_build_consensus_response(self):
        ...
        sources = [{"response": "Respuesta A", "confidence": 0.9}, {"response": "Respuesta B", "confidence": 0.7}]

        analysis = {"consensus_level": 0.8, "primary_source": sources[0]}
...
class TestMergerIntegration:
    ...
    async def test_merger_uses_real_analysis(self):
        ...
        result = await merger._analyze_consensus(
            [{"content": "Test A", "confidence": 0.8}, {"content": "Test B", "confidence": 0.7}]
        )
