...
class TestSubprocessSecurity:
    ...
    def test_safe_subprocess_run_rejects_shell(self):
        ...
        result = safe_subprocess_run(
            ["echo", "test"], shell=True, capture_output=True  # Debería ser ignorado/forzado a False
        )
...
class TestSecurityMonitor:
    ...
    def test_rate_limiting(self):
        ...
        try:
            from sheily_core.safety import SecurityConfig, get_security_monitor
        except ImportError:
    ...
    def test_security_event_recording(self):
        ...
        from sheily_core.safety import SecurityConfig, create_security_event, get_security_monitor
...
class TestInputValidation:
    ...
    def test_path_traversal_protection(self):
        ...
        for dangerous in dangerous_paths:
            ...
            assert not str(full_path).startswith(str(base_dir.resolve())) or str(full_path) == str(base_dir.resolve())
